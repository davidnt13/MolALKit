...
python molalkit_run --data_public CYP3A4_Veith --metrics roc_auc mcc accuracy precision recall f1_score --learning_type passive --model_config_selector MLP_Morgan_BinaryClassification_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 0 --save_dir "test data/cyp/chemprop/cyp_chemprop_explorative_nf" --batch_size 2
...
# python molalkit_run --data_public bbb_martins --metrics roc_auc mcc accuracy precision recall f1_score --learning_type passive --model_config_selector RandomForest_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 0 --save_dir bbb_rf
