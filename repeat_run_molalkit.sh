...
# python molalkit_run --data_public pgp_broccatelli --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector David_MLP_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 1 --batch_size 2 --save_dir "test data/pgp/mlp/pgp_mlp_minf2" --forget_protocol MCDropoutForgetter --forget_size 200
