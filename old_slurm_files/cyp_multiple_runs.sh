...
python molalkit_run --data_public CYP3A4_Veith --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector David_MLP_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 1 --batch_size 2 --save_dir "test data/cyp/mlp/cyp_mlp_explorative_nf" # --forget_protocol MCDropoutForgetter --forget_size 200 --mc_forget_version "max"

python molalkit_run --data_public CYP3A4_Veith --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector David_MLP_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 2 --batch_size 2 --save_dir "test data/cyp/mlp/cyp_mlp_explorative_nf2" # --forget_protocol MCDropoutForgetter --forget_size 200 --mc_forget_version "max"

python molalkit_run --data_public CYP3A4_Veith --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector David_MLP_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 3 --batch_size 2 --save_dir "test data/cyp/mlp/cyp_mlp_explorative_nf3"  #--forget_protocol MCDropoutForgetter --forget_size 200 --mc_forget_version "max"
