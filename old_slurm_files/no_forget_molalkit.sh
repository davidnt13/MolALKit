...
python molalkit_run --data_public CYP3A4_Veith --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector RandomForest_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 0 --save_dir "test data/cyp/rf/cyp_rf_explorative_nf" --batch_size 2
