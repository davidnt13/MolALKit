...
python molalkit_run --data_public pgp_broccatelli --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector RandomForest_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 1 --batch_size 2 --save_dir "test data/pgp/rf/pgp_rf_minf_perturb100" --forget_protocol min_oob_uncertainty --forget_size 10 #--mc_forget_version "min"

python molalkit_run --data_public pgp_broccatelli --metrics roc_auc mcc accuracy precision recall f1_score --learning_type explorative --model_config_selector David_MLP_Morgan_Config --split_type scaffold_order --split_sizes 0.5 0.5 --evaluate_stride 10 --seed 1 --batch_size 2 --save_dir "test data/pgp/mlp/pgp_mlp_minf_perturb100" --forget_protocol MCDropoutForgetter --forget_size 10 --mc_forget_version "min"
